...
本站支持 `<mark class="va-hl">文字</mark>` 霓虹荧光高亮，起排版装饰作用。语法：两侧各两个等号。
...
| 学习路径 | 目标：<mark class="va-hl">手写 GEMM 达到 cuBLAS 80% 性能</mark> |
...
- 荧光是排版装饰，</mark>不要用它表达语义强调==；语义强调继续用 `**加粗**`。
